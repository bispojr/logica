...
28 de abril de 2026
    ...
    \vspace{0.5cm}
        ...
        \begin{question}
\item Sejam as proposições $p$: “O processo foi finalizado corretamente”, e $q$: “A memória foi alocada com sucesso”. Traduza a proposição
$\sim \big( (\sim p \land q) \leftrightarrow p \big)$
