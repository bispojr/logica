...
30 de abril de 2026
    ...
    \vspace{0.5cm}
     ...
     \begin{question}
		...
		\begin{center}
			$(\sim k \rightarrow u \wedge v)$ $\veebar$ $\sim v$
		\end{center}
    \end{question}
{
    ...
    \begin{center}
        \vspace{0.5cm}
        % Tabela-verdade para (\sim k \rightarrow u \wedge v) \veebar \sim v
        \begin{tabular}{c|c|c||c|c|c|c||c}
            & & & & & (1) & (2) & (3) \\
            \hline
            $k$ & $u$ & $v$ & $\sim k$ & $u \wedge v$ & $\sim k \rightarrow u \wedge v$ & $\sim v$ & $(1)$ $\veebar$ (2) \\
            \hline
            V & V & V & F & V & V & F & V \\
            V & V & F & F & F & V & V & F \\
            V & F & V & F & F & V & F & V \\
