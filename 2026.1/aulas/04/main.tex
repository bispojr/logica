...
\date{\textbf{26 de março de 2026} }
	...
	\begin{frame}{Objetivos da Aula}
		\begin{itemize}
			...
			\begin{itemize}[label=$\bullet$]
				\item Proposição (Simples e Composta); {\bf \color{blue} [OK]}
				\item Conectivos; {\bf \color{blue} [OK]}
				\item Valor Lógico; {\bf \color{blue} [OK]}
				\item Tabela-Verdade. {\bf \color{blue} [OK]}
			\end{itemize}
		\item Compreender os Princípios da 
			\begin{itemize}[label=$\bullet$]
				\item Não-Contradição; e {\bf \color{blue} [OK]}
				\item do Terceiro Excluído; {\bf \color{blue} [OK]}
			\end{itemize}
		\item Saber utilizar a notação sobre valor lógico. {\bf \color{yellow} [---]}
		\end{itemize}
	\end{frame}  
...
\begin{frame}{Próxima Aula}
    ...
    \begin{block}{Páginas}
        \begin{itemize}
        \item {\bf Aula 05 (31/03)}: Seção 2.5 a 2.7 (pp. 21-25) {\bf \color{blue} [L1]} 
        \end{itemize}
    \end{block}
\end{frame}
